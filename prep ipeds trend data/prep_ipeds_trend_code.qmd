...
def download(file_url,download_location):
	...
	#file_name = file_url.split("/")[-1:][0] - CHANGE FOR NEW URL
...
class IWD_file():
	def __init__(self,ipeds_file, year):
		...
		#self.data_file_dl = "https://nces.ed.gov/ipeds/datacenter/data/{0}".format(self.data_file_name) - CHANGE FOR NEW URL
...
# main(year = rv_year, file = "GR200_[YEAR]")
