...
in order to do full compile, need to use loop to break file apart, call the values and varnames functions, and then bind file back together. (otherwise computer memory is insufficient to run the two functions)
```{r clean}
