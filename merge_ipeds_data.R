...
script_lookup_helper <- RCurl::getURL("https://raw.githubusercontent.com/emma-morgan/IPEDS_longitudinal/master/lookup_helper.R", 
                                      ssl.verifypeer = FALSE)
eval(parse(text = script_lookup_helper))
rm("script_lookup_helper")

script_read_clean_data <- RCurl::getURL("https://raw.githubusercontent.com/emma-morgan/IPEDS_longitudinal/master/read_clean_data.R", 
                                        ssl.verifypeer = FALSE)
