...
script_lookup_helper <- RCurl::getURL("https://raw.githubusercontent.com/emmamorgan-tufts/IPEDS_longitudinal/develop_ka/lookup_helper.R", 
                                      ssl.verifypeer = FALSE)
eval(parse(text = script_lookup_helper))
rm("script_lookup_helper")

script_read_clean_data <- RCurl::getURL("https://raw.githubusercontent.com/emmamorgan-tufts/IPEDS_longitudinal/develop_ka/read_clean_data.R", 
                                        ssl.verifypeer = FALSE)
