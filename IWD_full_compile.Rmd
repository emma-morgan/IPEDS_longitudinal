---
title: "IPEDS World Dominiation Data Check -- attempting full compile by chunking file apart"
author: "KMF"
date: "March 2019"
output:
  html_document: 
...
2) Peer list -- in this case peer list is null becaseu we are trying FULL compile
...
for (i in seq(1, x, 100)) {
  ds <- IPEDS_data %>% filter(UNITID %in% IDS[i:(i+99)])
