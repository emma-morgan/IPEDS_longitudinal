...
## This will compile ALL ipeds survyes each time
## You will know this worked if you see new files in the "compiled" fodler for each survey here:C:\Users\kfoley\Massachusetts Institute of Technology\IWD - Data

```{r compile}
source(file = "run_all_iwd_compile.R")
```

## Zip up trend files - copied and pasted from MH's IWD_packager.py
## Takes zero arduments.   zips all surveys each time
