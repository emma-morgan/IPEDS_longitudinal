...
def main(year = "2023", file = "ADM[YEAR]"):
...
## Clean and create trend files

```{r compile}
source(file = "GitHub/IPEDS_longitudinal/test python/run_all_iwd_compile.R")
```
